...
REPORTERS = Graphviz DSL Network LLVM Facebook Bitcoin StraceLinux JSON CDM CamFlow
# -------------------------------------------
...
build-linuxaudit: build/spade/reporter/Audit.class lib/spadeAuditBridge audit-kernel-module
